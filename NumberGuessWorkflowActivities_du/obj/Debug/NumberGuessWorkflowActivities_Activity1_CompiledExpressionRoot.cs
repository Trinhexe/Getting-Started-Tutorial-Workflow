namespace NumberGuessWorkflowActivities {
    ...
    #line 21 "D:\WBF\Workflow\NumberGuessWorkflowActivities_du\Prompt.xaml"
    using System;
    
    #line default
    #line hidden
    
    #line 1 "D:\WBF\Workflow\NumberGuessWorkflowActivities_du\Prompt.xaml"
    using System.Collections;
    
    #line default
    #line hidden
    
    #line 22 "D:\WBF\Workflow\NumberGuessWorkflowActivities_du\Prompt.xaml"
    ...
    #line 23 "D:\WBF\Workflow\NumberGuessWorkflowActivities_du\Prompt.xaml"
    using System.Data;
    
    #line default
    #line hidden
    
    #line 24 "D:\WBF\Workflow\NumberGuessWorkflowActivities_du\Prompt.xaml"
    using System.Linq;
    
    #line default
    #line hidden
    
    #line 25 "D:\WBF\Workflow\NumberGuessWorkflowActivities_du\Prompt.xaml"
    using System.Text;
    ...
    public partial class Activity1 : System.Activities.XamlIntegration.ICompiledExpressionRoot {
        ...
        public object InvokeExpression(int expressionId, System.Collections.Generic.IList<System.Activities.LocationReference> locations, System.Activities.ActivityContext activityContext) {
            ...
            if ((this.dataContextActivities == null)) {
                this.dataContextActivities = Activity1_TypedDataContext1_ForReadOnly.GetDataContextActivitiesHelper(this.rootActivity, this.forImplementation);
            }
            if ((expressionId == 0)) {
                System.Activities.XamlIntegration.CompiledDataContext[] cachedCompiledDataContext = Activity1_TypedDataContext1_ForReadOnly.GetCompiledDataContextCacheHelper(this.dataContextActivities, activityContext, this.rootActivity, this.forImplementation, 2);
                if ((cachedCompiledDataContext[0] == null)) {
                    cachedCompiledDataContext[0] = new Activity1_TypedDataContext1_ForReadOnly(locations, activityContext, true);
                }
                Activity1_TypedDataContext1_ForReadOnly valDataContext0 = ((Activity1_TypedDataContext1_ForReadOnly)(cachedCompiledDataContext[0]));
            ...
            if ((expressionId == 1)) {
                ...
                Activity1_TypedDataContext1_ForReadOnly valDataContext1 = ((Activity1_TypedDataContext1_ForReadOnly)(cachedCompiledDataContext[0]));
                return valDataContext1.ValueType___Expr1Get();
            }
            if ((expressionId == 2)) {
                System.Activities.XamlIntegration.CompiledDataContext[] cachedCompiledDataContext = Activity1_TypedDataContext1.GetCompiledDataContextCacheHelper(this.dataContextActivities, activityContext, this.rootActivity, this.forImplementation, 2);
                if ((cachedCompiledDataContext[1] == null)) {
                    cachedCompiledDataContext[1] = new Activity1_TypedDataContext1(locations, activityContext, true);
                }
                Activity1_TypedDataContext1 refDataContext2 = ((Activity1_TypedDataContext1)(cachedCompiledDataContext[1]));
        ...
        public object InvokeExpression(int expressionId, System.Collections.Generic.IList<System.Activities.Location> locations) {
            ...
            if ((expressionId == 0)) {
                Activity1_TypedDataContext1_ForReadOnly valDataContext0 = new Activity1_TypedDataContext1_ForReadOnly(locations, true);
                return valDataContext0.ValueType___Expr0Get();
            }
            if ((expressionId == 1)) {
                Activity1_TypedDataContext1_ForReadOnly valDataContext1 = new Activity1_TypedDataContext1_ForReadOnly(locations, true);
                return valDataContext1.ValueType___Expr1Get();
            }
            if ((expressionId == 2)) {
                Activity1_TypedDataContext1 refDataContext2 = new Activity1_TypedDataContext1(locations, true);
        ...
        public bool CanExecuteExpression(string expressionText, bool isReference, System.Collections.Generic.IList<System.Activities.LocationReference> locations, out int expressionId) {
            if (((isReference == false) 
                        && ((expressionText == "Text") 
                        && (Activity1_TypedDataContext1_ForReadOnly.Validate(locations, true, 0) == true)))) {
                expressionId = 0;
                return true;
            }
            if (((isReference == false) 
            ...
            if (((isReference == true) 
                        ...
                        && (Activity1_TypedDataContext1.Validate(locations, true, 0) == true)))) {
                expressionId = 2;
                return true;
            }
            expressionId = -1;
        ...
        public System.Linq.Expressions.Expression GetExpressionTreeForExpression(int expressionId, System.Collections.Generic.IList<System.Activities.LocationReference> locationReferences) {
            if ((expressionId == 0)) {
                return new Activity1_TypedDataContext1_ForReadOnly(locationReferences).@__Expr0GetTree();
            }
            if ((expressionId == 1)) {
                return new Activity1_TypedDataContext1_ForReadOnly(locationReferences).@__Expr1GetTree();
            }
            if ((expressionId == 2)) {
                return new Activity1_TypedDataContext1(locationReferences).@__Expr2GetTree();
            }
            return null;
        }
        ...
        private class Activity1_TypedDataContext1 : Activity1_TypedDataContext0 {
            ...
            internal System.Linq.Expressions.Expression @__Expr2GetTree() {
                ...
                #line 59 "D:\WBF\WORKFLOW\NUMBERGUESSWORKFLOWACTIVITIES_DU\PROMPT.XAML"
        ...
        private class Activity1_TypedDataContext1_ForReadOnly : Activity1_TypedDataContext0_ForReadOnly {
            ...
            internal System.Linq.Expressions.Expression @__Expr0GetTree() {
                ...
                #line 48 "D:\WBF\WORKFLOW\NUMBERGUESSWORKFLOWACTIVITIES_DU\PROMPT.XAML"
        ...
        Text;
            ...
            internal System.Linq.Expressions.Expression @__Expr1GetTree() {
                ...
                #line 54 "D:\WBF\WORKFLOW\NUMBERGUESSWORKFLOWACTIVITIES_DU\PROMPT.XAML"
                System.Linq.Expressions.Expression<System.Func<string>> expression = () => 
          BookmarkName;
